...
class ChatConsumer(WebsocketConsumer):
    ...
    def receive_friend_list(self, data):
        ...
        serialized = FriendSerializer(
            connection, context={'user': user}, many=True)
    ...
    def receive_request_accept(self, data):
        ...
        self.send_group(connection.receiver.username,
                        'request.accept', serialized.data)
        # send new frend object to sender
        ...
        # send new frend object to reciever
        serialized_friend = FriendSerializer(
            connection,
            context={
        ...
        self.send_group(connection.reciever.username,
                        'friend.new', serialized_friend.data)
    ...
    def receive_search(self, data):
        ...
        # send search resuld back to this user
